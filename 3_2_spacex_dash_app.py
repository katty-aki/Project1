...
def get_plot(site, payload):
    if site == 'ALL':
        ...
        scatter = px.scatter(new_df, x = 'Payload Mass (kg)', y = 'class', color = "Booster Version", title = 'Success vs Payload')
        ...
        scatter = px.scatter(new_df2, x = 'Payload Mass (kg)', y =  'class', color = 'Booster Version', title = 'Success vs Payload')
        scatter.update_traces(marker_size=10)
        return scatter
